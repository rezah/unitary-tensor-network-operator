...
def plot(Count_list1, variance_list1,Count_list2, variance_list2,q,L):
...
def Store(variance_final1, variance_final2,q,L, file1, Count_final1, Count_final2):
 ...
 file1.write(str(q)  + "  " + str(variance_final1[Length]) + "  " + str(variance_final2[Length]) +  "  "+ str(var1)+"  "+ str(var2) + "  "+ str(Count_final1[Length1])+ "  "+ str(Count_final2[Length1]) +"\n")
